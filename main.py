...
from crud.read import get_places, get_users, get_user_by_id, get_place_by_name
...
test = get_place_by_name(session, "Central Park")
print("Place found:", test.id, test.name, test.location)
